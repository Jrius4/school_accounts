...
if(token!==null){
    store.dispatch("getUserTokenAcion").then((response) => {
    }).catch((err) => {
        console.error(err)
    });
}
...
Vue.component(
    'search-student',require('./components/admin/SearchStudent.vue').default
);
Vue.component(
    'burser',require('./components/burser/burser.vue').default
);
Vue.component('make-expense-component',require('./components/burser/expenses/MakeExpense.vue').default);

Vue.component(
    'app-component',require('./components/App').default
);
Vue.component('dashboard-component',require('./components/user/Dashboard.vue').default);
...
Vue.component('notification-bar',require('./components/common/NotificationBar.vue').default)
Vue.component('chat-room',require('./components/chatRoom/ChatRoom.vue').default);
Vue.component('make-expense',require('./components/burser/expenses/MakeExpense.vue').default);
Vue.component('selectfield-component',require('./components/common/SelectField.vue').default);
//Vue.component('employees-component',require('./components/employees/search/Employees.vue').default);
Vue.component('comment-component',require('./components/common/Comments.vue').default);
// EmployeeSalary
