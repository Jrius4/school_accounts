                        ...
                        <div class="sticky">
                            <v-card>
                                <v-sheet elevation="10" class="py-4 px-1">
                                    ...
                                    >
                                        <v-chip @click="formSelector('role')"
                                            >Role</v-chip
                                        >
                                        <v-chip
                                            @click="formSelector('permission')"
                                            >Permission</v-chip
                                        >
                                        <v-chip @click="formSelector('user')"
                                            >User</v-chip
                                        >
                                    </v-chip-group>
                                </v-sheet>
...
export default {
    ...
    methods: {
        ...
        getRoles() {
            ...
            this.$store
                .dispatch("rolesModule/GET_ROLES_ACTION", data)
                .finally(() => {
        ...
        removePermission(item) {
            let index = this.PermissionSelection.findIndex(
                p => p.id == item.id
            );
            ...
            if (!this.roleName) {
                ...
                this.$store
                    ...
                    .then(res => {
                        ...
                        this.$store.dispatch(
                            "alertActionModule/ALERT_ACTION",
                            alert
                        );
                    })
                    .catch(() => {
