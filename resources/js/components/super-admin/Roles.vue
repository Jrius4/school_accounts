                ...
                <table class="table table-sm">
                  ...
                  <tbody>
                    <tr v-for="(i,k) in roles" :key="k">
                      <td colspan="1">{{i.display_name}}</td>
                      <td>{{i.users ?i.users.length:'none'}}</td>
                      <td>
                        <v-icon small fab class="mr-2" color="blue" @click="viewitem(i)">fa fa-eye</v-icon>
                        <v-icon small fab class="mr-2" color="green" @click="edititem(i)">fa fa-edit</v-icon>
                        <v-icon
                          small
                          fab
                          class="mr-2"
...
export default {
  ...
  data: () => {
    return {
      items: [
        { name: "Head Teacher", count: 7 },
        { name: "Teacher", count: 9 },
        { name: "Academic", count: 2 },
        { name: "Accountant", count: 4 },
      ],
      search: "",
      circle: true,
      disabled: false,
