    ...
    export default {
        ...
        computed:{
            ...
            getData(){
                ...
                else if (this.queryType === 'daily_by_group')
                {
                    ...
                    this.payments.forEach(item=>{
                        xAxisData.push(item.paid_day);
                        data1.push((item.paymentType).toLowerCase() === 'asset'?item.total_amount:0);
                        data2.push((item.paymentType).toLowerCase() === 'loan'?item.total_amount:0);
                        data3.push((item.paymentType).toLowerCase() === 'student'?item.total_amount:0);
                    });

                    dataBar = {
                        title:{
                            text:"Daily Payments by Groups",
                            left:'center',
                            top:20
                        },
                ...
                else if(this.queryType === 'weekly_by_group')
                {
                    ...
                    dataBar = {
                        title:{
                            text:"Weekly Payments by Groups",
                            left:'center',
                            top:20
                        },
                    ...
                    dataBar = {
                        ...
                        title:{
                            text:"Monthly Payments by Groups",
                            left:'center',
                            top:20
                        },
                        legend:{
                    ...
                    dataBar = {
                        title:{
                            text:"Yearly Payments by Groups",
                            left:'center',
                            top:20
                        },
                        grid:{
        ...
        methods:{
            ...
            getPayments(){
                ...
                this.$store.dispatch('GET_PAYMENTS_INCOME_ACTION',data).finally(()=>{
