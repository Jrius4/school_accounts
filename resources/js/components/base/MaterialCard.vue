  ...
  <v-card v-bind="$attrs" :class="classes" class="v-card--material pa-3">
    <div class="d-flex grow flex-wrap">
      ...
      >
        ...
        <div v-if="text" :class="`headline font-weight-thin ${titleColor}`" v-text="text" />
      </v-sheet>
      ...
      <div v-else-if="icon && title" :class="`ml-4  ${titleColor}`">
        <div :class="`display-1 card-title font-weight-light  ${titleColor}`" v-text="title" />
      </div>
    </div>
