    ...
    <div class="card card-dark card-tabs elevation-2 animated flipInX">
        <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link @if($student->schclass_id >= 1 && $student->schclass_id <= 2) active @endif" id="custom-content-above-senior-1-2-tab" data-toggle="pill" href="#custom-content-above-senior-1-2" role="tab" aria-controls="custom-content-above-senior-1-2" aria-selected="true">S.1 & S.2</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link @if($student->schclass_id >= 3 && $student->schclass_id <= 4) active @endif" id="custom-content-above-senior-3-4-tab" data-toggle="pill" href="#custom-content-above-senior-3-4" role="tab" aria-controls="custom-content-above-senior-3-4" aria-selected="false">S.3 & S.4</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link @if($student->schclass_id >= 5 && $student->schclass_id <= 6) active @endif" id="custom-content-above-senior-5-6-tab" data-toggle="pill" href="#custom-content-above-senior-5-6" role="tab" aria-controls="custom-content-above-senior-5-6" aria-selected="false">S.5 & S.6</a>
                </li>
              </ul>
        </div>
        <div class="card-body">
          ...
          <div class="tab-content" id="custom-content-above-tabContent">
            <div class="tab-pane fade @if($student->schclass_id >= 1 && $student->schclass_id <= 2)show  active @endif" id="custom-content-above-senior-1-2" role="tabpanel" aria-labelledby="custom-content-above-senior-1-2-tab">
                        ...
                        <div class="col-md-10 elevation-2" style="min-height:200px;">
                            ...
                            <div class="form-group col-12 d-block py-2 my-1">
                                ...
                                <select name="gender" class=" form-control">
                                    ...
                                    <option value="male" @if($student->gender == "male") selected @elseif(@old('gender')=='male') selected @endif>Male</option>
                                    <option value="female" @if($student->gender == "female") selected @elseif(@old('gender')== 'female') selected  @endif>Female</option>
                                </select>
                            </div>
                            <div class="form-group col-12 d-block py-2 my-1">
            ...
            <div class="tab-pane fade @if($student->schclass_id >= 3 && $student->schclass_id <= 4)show  active @endif" id="custom-content-above-senior-3-4" role="tabpanel" aria-labelledby="custom-content-above-senior-3-4-tab">
            ...
            <div class="tab-pane fade @if($student->schclass_id >= 5 && $student->schclass_id <= 6)show  active @endif" id="custom-content-above-senior-5-6" role="tabpanel" aria-labelledby="custom-content-above-senior-5-6-tab">
