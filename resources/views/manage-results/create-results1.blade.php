...
@section('admin-content')
                                    ...
                                    <div class="form admin-panel-content animated bounce">
                                        ...
                                        <div class="">
                                            <div class="chosen-select-single mg-b-20">
                                                <select name="schclass" id="schclass" class="action form-control"></select>
                                            </div>
                                        </div>
                                        <label>Subject</label>
                                        <div class="">
                                        ...
                                        <div class="">
                                            <div class="chosen-select-single mg-b-20">
                                                  <select name="student" class="action form-control" id="student"></select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="">
                                            <div class="chosen-select-single mg-b-20">
                                                    <select name="has_papers" class="action form-control" id="has_papers">
        ...
        @include('manage-results.scripts')
