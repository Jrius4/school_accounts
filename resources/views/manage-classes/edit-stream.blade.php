...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb elevation-2">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="{{route('classes.index')}}">Manage Class</a></li>
            ...
            <div class="card elevation-2 animated flipInX">
                ...
                <div class="card-body">
                            ...
                            <div class="container row d-flex justify-content-center">
                                ...
                                <input type="hidden" name="stream_id" id="stream_id" value="{{$schstream->id}}">
                                ...
                                <div class="form-group py-2 col-md-8">
                                    ...
                                    <div class="row">
                                        <select id="schclasses" name="classes" class="form-control bg-transparent d-block" class="col-sm-12" style="color:aliceblue!important" multiple="multiple">
                                            ...
                                            <option value="{{$class->id}}" @if($schstream->schoolclasses()->where('id',$class->id)->count()>0) @if($class->id === $schstream->schoolclasses()->where('id',$class->id)->first()->id) selected @endif @endif>{{$class->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group py-2 col-md-8">
                                    ...
                                    <input type="text" name="name" id="nameInput" value="{{$schstream->name}}" placeholder="Class Name" class="form-control bg-transparent d-block"/>
...
<script type="text/javascript">
    ...
    // }
        ...
        $('#createClassForm').on('submit',(function(e){
            ...
            var schstream_id = $('#stream_id').val();
            $.ajax({
                type:"POST",
                url:'{{url("/edit-stream")}}',
                data:formData,
