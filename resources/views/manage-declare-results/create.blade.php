...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb elevation-2">
        ...
        <li class="breadcrumb-item active" aria-current="page">Declare Class Results</li>
    </ol>
</nav>
    ...
    <div class="col-12">
        <div class="card elevation-2 animated flipInX">
            <div class="card-header row">
                <h3 class="card-title mr-auto">Declare Class Results</h3>
            </div>
            <div class="card-body">
                ...
                <div class="container row d-flex justify-content-center">
                            ...
                            @include('manage-declare-results.form')
