                                            ...
                                            @else
                                                @foreach ($staffs as $staff)
                                                    <tr>
                                                        ...
                                                        <td>{{$staff->users->count()}}</td>
                                                        <td><a href="{{route('users.create')}}"><i class="fa fa-user-plus"></i></a></td>
                                                        <td>
                                                        <a href="{{route('staffs.show',$staff->slug)}}"><i class="fa fa-eye"></i></a>|
                                                        <a href="{{route('staffs.edit',$staff->slug)}}"><i class="fa fa-edit"></i></a>|
                                                        <a href="{{route('staffs.destroy',$staff->slug)}}"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
