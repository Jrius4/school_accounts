...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb elevation-2">
        ...
        <li class="breadcrumb-item active" aria-current="page">Manage Students Senior 1 - 2</li>
    </ol>
</nav>
    ...
    <div class="col-12">
        <div class="card elevation-2 animated bounce">
            <div class="card-header row">
                ...
                <a href="{{url('/')}}" class="btn btn-sm btn-outline-primary">Create Register Student</a>
            </div>
            <div class="card-body">
                <div class="row">
