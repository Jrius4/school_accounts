                        ...
                        @else
                            @foreach ($subjects as $subject)
                                <tr>
                                    ...
                                    <td>{{$subject->level}}</td>
                                    <td>{{$subject->subject_compulsory?'Yes':'No'}}</td>
                                    <td>
                                        {!! Form::open(['method' => 'DELETE', 'route' => ['subjects.destroy', $subject->id]]) !!}
                                        <a href="{{route('subjects.edit',$subject->id)}}" class="btn btn-xs btn-info"><i class="fa fas fa-edit"></i></a>|<button onclick="return confirm('Are you sure?');" type="submit" class="btn btn-xs btn-danger">
