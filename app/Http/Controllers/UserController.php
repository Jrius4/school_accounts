...
class UserController extends BackendController
{
    ...
    public function export()
    {
        ...
        if (\request()->exportType == "excel") {
            return $this->exportFile('users.xlsx');
        } elseif (\request()->exportType == "csv")
            return $this->exportFile('sponsors.csv');
        else
            return $this->exportFile('sponsors.pdf');
    }

    private function exportFile($file): BinaryFileResponse
    {
