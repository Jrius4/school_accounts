	...
	$date = date("d/m/y");
	 ...
	 $files2 = $_FILES['admissionform'];
		...
		if($fileError2 === 0){
			...
			$sqlq="INSERT INTO tbls21(FullName,RollNo,ClassId,StreamId,Gender,fees,Status,profilepic,medicalform,admissionform,CreationDate,UpdationDate) VALUES('$fn','$rn',$cid,$stid,'$g',$f,1,'$fileName','$fileName1','$fileName2','$date','Not yet updated')";
